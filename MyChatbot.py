...
with st.sidebar:
    ...
    use_smol_agents = col2.checkbox('🤖 Smol Agents', value=False)
    
    # Show Smol Agents info when enabled
    if use_smol_agents:
        st.info("🤖 **Smol Agents enabled**: AI will use web search, code execution, and multi-step reasoning for complex tasks.")
